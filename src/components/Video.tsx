                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-6">
                                <img 
                                    ...
                                    src="https://github.com/juniorvilas.png" 
                                    alt="teacher image" 
                                    />
                                <div className="leading-relaxed">
                                    <strong className="font-bold text-2xl block">Carlindo Junior</strong>
                                    <span className="text-gray-200 text-sm block">Desenvolvedor Frontend Jr</span>
                                </div>
                            </div>
                        </div>
